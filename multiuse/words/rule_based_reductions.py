...
def normalize_to_base_terms(terms: Sequence[str], minimum_word_length_match: int = 3) -> list[str]:
...
def filter_redundant_long_terms(terms: Sequence[str], minimum_word_length_match: int = 3) -> list[str]:
